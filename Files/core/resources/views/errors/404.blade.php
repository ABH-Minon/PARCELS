...
<head>
  ...
  <!-- bootstrap 4  -->
  <link rel="stylesheet" href="{{ asset('css/errors/css/bootstrap.min.css') }}">
  <!-- dashdoard main css -->
  <link rel="stylesheet" href="{{ asset('css/errors/css/main.css') }}">
</head>
  <body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-7 text-center">
          <img src="{{ asset('css/errors/images/error-404.png') }}" alt="@lang('image')">
